...
/**
 * "GET IN Touch" — matches the target's home-page contact form.
 * Title, brief lead, fields: name / email / subject / message,
 * privacy checkbox, submit. On submit, falls back to mailto: with the
 * composed message — honest fallback when no backend endpoint is configured.
 */
export function GetInTouch() {
  ...
  return (
    <section className="relative overflow-hidden border-t border-line py-20 sm:py-28" id="contact">
